    ...
    for connectionName in connectionsDict.keys():
    	...
    	for day in ['weekday','weekend']:
    		...
    		for direction in ['positive','negative']:
    			text += '"%s":[' %(direction)
    			temp = connectionsDict[connectionName][day][direction ]
    			for number in temp:
    				text += '%d,'%(number)
    			text = text[:-1] + '],'
		text = text[:-1] + '},'    # 未知缩进bug
...
# connectionsDict = init()
# # print connectionsDict["富锦路,友谊西路,1"]
# saveConnectionsData(connectionsDict)
